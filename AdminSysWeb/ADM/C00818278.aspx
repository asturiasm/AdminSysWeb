...
<%@ Page Language="vb" AutoEventWireup="false" Inherits="SIGESWeb.C00818278" CodeFile="C00818278.aspx.vb"  MaintainScrollPositionOnPostback="true" %>
		...
		<form id="Form1" method="post" runat="server">
            ...
            <table width="100%">
			   <colgroup>
                ...
                <tr>
			        <td colspan="4" class="ColTitulo">Alcance de Objetos</td>
		        </tr> 
                <tr>
                    <td align="center" ><asp:Button ID="btnMostrar" runat="server" Text="Mostrar Arbol" />
                        <br />
                    </td>                     
                </tr>
            </table>   
